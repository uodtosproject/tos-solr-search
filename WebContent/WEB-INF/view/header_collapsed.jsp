    ...
    <body>
        ...
        <div class="container">
			...
			<div class="hero-unit">
	            ...
	            <p class="lead">Check what Terms & Conditions say about some common issues involving your personal data and accounts.</p>
	        </div>
			<div class="row">
		    	<div class="span12">
		        	...
		        	<ul>
						...
						<% if(q.getCat().equalsIgnoreCase("1")) { %>
						<li><a href="<%=request.getContextPath()%>/question/<%= q.getId() %>" title="<%= q.getText() %>"><%= q.getText() %></a></li>
						<% } %>
						<% } %>
					</ul>
					<% } %>
